...
UPDATE_JSON="$(sui client --client.config "$CLIENT_CONFIG" call --package "$PACKAGE_ID" --module facility --function update_borrowing_base --args "$FACILITY_ID" 124010000 71200000 8200 40200400 0x757064617465642d65766964656e63652d726f6f742d7632 0x6 --gas-budget 100000000 --json)"
